...
export const PropertyDetailsModal: React.FC<PropertyDetailsModalProps> = ({
  ...
  const hasReviewed = property.reviews.some(
    (review) => review.client_id === currentClientId,
  );
    ...
    >
      ...
      >
        ...
        <div className="p-6 space-y-6 flex-1">
          {statusMessage && (
            <div
              className={`p-4 rounded-xl border font-semibold text-sm flex items-center gap-2 ${statusMessage.type === "success" ? "bg-emerald-50 text-emerald-800 border-emerald-200" : "bg-red-50 text-red-800 border-red-200"}`}
            >
          ...
          <div>
            ...
            <p className="text-sm font-semibold mt-2 text-slate-700">
              Vendido por: {property.realEstateName}
            </p>
          </div>
                  ...
                  <div className="space-y-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full md:w-1/3 px-3 py-2 border border-slate-200 rounded-lg text-sm"
                        required
                      />
                    </div>
                    <div>
                    ...
                    >
                      <div className="flex items-center justify-between mb-1">
                        <span className="text-xs font-bold text-slate-900">
                          {isMyReview
                            ? "Tu reseña"
                            : review.client_name || "Usuario Anónimo"}
                        </span>
